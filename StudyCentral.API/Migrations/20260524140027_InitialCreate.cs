    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("08deb82b-9368-4f46-8c29-b0498685408c"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1517), "Master advanced programming techniques with this course.", null, "Advanced Programming" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("08deb68b-5c0f-447c-86a2-152bdf58b714"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1408), "user@mail.com", "John", "Student", "$2a$11$ZZdlueio8rsj67q/d/ZiBe03uM1mX0Y9JfFjwcP/X0KSRiE5G4Ke6", null, 1, new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1409) },
                    { new Guid("08deb68b-c568-4182-841f-7f7f7da655d8"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1419), "teacher@mail.com", "Jonathan", "Teacher", "$2a$11$ZZdlueio8rsj67q/d/ZiBe03uM1mX0Y9JfFjwcP/X0KSRiE5G4Ke6", null, 2, new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1419) },
                    { new Guid("08deb68b-ca1a-49f8-80a9-cebcdca84136"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1422), "admin@mail.com", "Mister", "Admin", "$2a$11$ZZdlueio8rsj67q/d/ZiBe03uM1mX0Y9JfFjwcP/X0KSRiE5G4Ke6", null, 3, new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1422) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("08deb82b-8d61-4e71-8ab5-2205c9dd79ba"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1511), "Learn the basics of programming with this introductory course.", new Guid("08deb68b-c568-4182-841f-7f7f7da655d8"), "Introduction to Programming" },
                    { new Guid("08deb82b-9093-4baa-806d-5a095a01328f"), new DateTime(2026, 5, 24, 14, 0, 27, 359, DateTimeKind.Utc).AddTicks(1515), "Explore the art of programming with this course.", new Guid("08deb68b-c568-4182-841f-7f7f7da655d8"), "The Art of Programming" }
                });
