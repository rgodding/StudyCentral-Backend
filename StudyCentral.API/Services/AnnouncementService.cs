...
public class AnnouncementService : IAnnouncementService
{
    ...
    public async Task<Announcement> GetAnnouncementById(Guid announcementId)
    {
        return await _dbContext.Announcements
               ...
               ?? throw new KeyNotFoundException($"Announcement with id {announcementId} was not found");
    }
    ...
    public async Task<Announcement> UpdateAnnouncement(Guid teacherId, Guid announcementId,
